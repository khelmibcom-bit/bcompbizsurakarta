    ...
    <section id="layanan" className="py-20 md:py-32 lg:py-40 bg-bg-elevated">
      <div className="container-tech">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-0">
          {services.map((s) => (
            <div key={s.num} className="py-6 md:py-8 border-b border-border sm:border-r sm:last:border-r-0 sm:[&:nth-child(2n)]:border-r-0 lg:[&:nth-child(2n)]:border-r lg:[&:nth-child(3n)]:border-r-0 px-0 sm:px-6 lg:px-8 group">
